...
export default function ResearchPage() {
  ...
  const tabData = {
    "Visa Verifi": {
      ...
      description:
        "Visa Verifi helps businesses resolve disputes and reduce fraud efficiently through advanced tools.",
      image: "/images/r3.jpg",
    },
    "Mastercard Ethoca": {
      title: "Mastercard Ethoca Collaboration",
      description:
        "Ethoca provides real-time fraud and dispute resolution, enhancing customer satisfaction.",
      image: "/images/r4.jpg",
    },
    "Mastercard Acquirer Collaboration": {
      title: "Acquirer Collaboration",
      description:
        "Mastercard Acquirer Collaboration enables seamless communication between issuers and acquirers.",
      image: "/images/r5.jpg",
    },
    "Authorize.net": {
      title: "Authorize.net Integration",
      description:
        "We integrate Authorize.net to process payments securely and manage chargebacks effectively.",
      image: "/images/r6.jpg",
    },
    "NMI": {
      title: "NMI Partnership",
      description:
        "NMI supports our operations with a flexible, scalable payment infrastructure.",
      image: "/images/r7.png",
    },
    "CheckoutChamp": {
      title: "CheckoutChamp Support",
      description:
        "CheckoutChamp enables faster, high-converting checkout experiences while keeping disputes in check.",
      image: "/images/r2.jpg",
    },
  };
  ...
  and payment fraud management — turning data into action.
          ...
          <Marquee gradient={false} speed={40} className="py-4">
            {brands.map((brand) => (
              ...
              >
                <Image src={brand.logo} alt={brand.name} width={30} height={30} />
      ...
      {/* CTA Section */}
      <section className="text-center py-12 bg-sky-600 text-white mt-20 rounded-xl max-w-5xl mx-auto">
